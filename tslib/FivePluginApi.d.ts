...
}, "alignItems" | "button" | "style" | "children" | "sx" | "className" | "tabIndex" | "autoFocus" | "disabled" | "action" | "selected" | "dense" | "classes" | "components" | "componentsProps" | "slotProps" | "slots" | "centerRipple" | "disableRipple" | "disableTouchRipple" | "focusRipple" | "focusVisibleClassName" | "LinkComponent" | "onFocusVisible" | "TouchRippleProps" | "touchRippleRef" | "disableGutters" | "divider" | "ContainerComponent" | "ContainerProps" | "disablePadding" | "secondaryAction">) => JSX.Element) & import("@mui/material/OverridableComponent").OverridableComponent<import("@mui/material").ExtendButtonBaseTypeMap<import("@mui/material/ListItem").ListItemTypeMap<{
    button: true;
